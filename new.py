...
bot = telebot.TeleBot('7947479058:AAGdfpOcUXwTusFt7ULgAgLbbslrc3E6v5M')
    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in admin_id:
            ...
            if user_id in bgmi_cooldown and (datetime.datetime.now() - bgmi_cooldown[user_id]).seconds < COOLDOWN_TIME:
                response = "You Are On Cooldown. Please Wait 150 sec Before Running The /attack1 Command Again buy premium instant attack with zero sec dm @RitikXyz099_OG."
                bot.reply_to(message, response, reply_markup=get_inline_keyboard())
                return
...
def welcome_start(message):
    ...
    response = f"Welcome to Your Home, {user_name}! Feel Free to Explore.\nTry To Run This Command : /help\nWelcome To The World's Best Ddos Bot\nBy 𝗡𝗔𝗥𝗨𝗧𝗢𝘅𝗣𝗔𝗠𝗣𝗔 BOT @RitikXyz099"
    bot.reply_to(message, response, reply_markup=get_inline_keyboard())
...
📩 <a href="https://t.me/+Ev-Rsvxey841MTA1">Contact Owner</a> 💥
'''
